...
const { ChainId } = require("@innoswap/sdk");
...
(async () => {
  try {
    ...
    for (const key of Object.keys(ChainId)) {
      ...
      // Grab file file names of the innoswap/icons repo at the token path
      ...
      for (const token of tokens) {
        ...
        if (!token.logoURI.includes("innoswap/icons")) {
          // TODO: Automate this part...
          const logoURI = `https://raw.githubusercontent.com/innova-foundation/icons/master/token/${icon}.jpg`;
